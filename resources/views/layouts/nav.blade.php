<nav class="navbar navbar-dark bg-inverse navbar-fixed-top">
                        ...
                        <a href="javascript:;">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h5 class="media-heading"><strong>daniel</strong>
                                    </h5>
    ...
    <div class="collapse navbar-collapse navbar-toggleable-sm navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav list-group">
            ...
            <li class="list-group-item">
                <a href="/users" id><i class="fa fa-fw fa-user"></i> Usuarios</a>
            </li>
            <li class="list-group-item">
                <a href="/products"><i class="fa fa-fw fa-tags"></i> Productos</a>
            </li>
            <li class="list-group-item">
                <a href="/categorias"><i class="fa fa-fw fa-tree"></i> Categorias</a>
            </li>
            <li class="list-group-item">
